...
export const popBoxCls = prefixCls + '-container';
export const leftBoxCls = prefixCls + '-left';
...
export const SPopup = sWrap<{
    ...
    styled('div')(props => {
        ...
        return css`
            ...
            position: relative;
            .${popBoxCls} {
                padding: 0 ${DT.T_SPACING_COMMON_MD};
            }
            .${leftBoxCls}{
                width: 76px;
            }
            .${footerCls} {
                ...
                border-top: 1px solid ${DT.T_CARD_LINE_COLOR_DEFAULT};
                padding: ${DT.T_SPACING_COMMON_MD};
                background: ${DT.T_COLOR_BG_DEFAULT_BRIGHT};
                position: relative;
                .${shortcutCls} {
                    cursor: pointer;
